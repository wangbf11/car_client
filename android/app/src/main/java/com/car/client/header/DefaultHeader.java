...
public class DefaultHeader extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context) {
        ...
        LayoutParams rlParent = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        rlParent.addRule(RelativeLayout.CENTER_IN_PARENT,RelativeLayout.TRUE);


        LayoutParams rlArrowView = new LayoutParams(DensityUtil.dp2px(20),DensityUtil.dp2px(20));
        ...
        LayoutParams rlHeaderText= new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        LayoutParams rlProgressView = new LayoutParams(DensityUtil.dp2px(20),DensityUtil.dp2px(20));
